                ...
                table.DataTable({
                    ...
                    columns: [{
                            ...
                            render: function(data, type, row) {
                                // console.log(row);
                                return `${row.pemilik.toUpperCase()}, ${data.toUpperCase()}, ${row.kabupaten.toUpperCase()}`;
                        ...
                        var html =
                            ...
                            tanggal_jual + `</td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="4">: ` + data.invoice
                            .toUpperCase() + `</td>
                                                                                <td colspan="3">` + data.kios.nama_kios
                            .toUpperCase() + `</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2">PEMBAYARAN </td>
                                                                                <td colspan="4">: ` + data.pembayaran
                            .toUpperCase() + `</td>
                                                                                <td colspan="3">` + data.kios.alamat
                            .toUpperCase() +
                            `, ` +
                            data
                            .kios
                            .kabupaten.toUpperCase() + `</td>
                                                                            </tr>
                                                                            <tr>
                        ...
                        data.detail_penjualan.map(function(value, index) {
                            ...
                            html +=
                                `<tr class="">
                                                                    ...
                                                                    <td colspan="2" style="width: 43%;">` + value
                                .nama_produk
                                .toUpperCase() +
                                " " +
                                value.kemasan.toUpperCase() + `</td>
                                                                    <td style="width: 5%;text-align:center">` + value.qty + `</td>
                                                                    <td style="width: 5%;text-align:center">` + value
                                .satuan
                                .toUpperCase() + `</td>
                                ...
                                number_format(
                                    ...
                                    .harga_perdos,
                                    1) + `</td>
                                                                    <td style="width: 5%;text-align:center">` + value.ket
                                .toUpperCase() + `</td>
                                                                    <td style="width: 5%;text-align:center">` + value
                                .disc + `</td>
                                                                    <td style="width: 10%;text-align:right">` + value
                                .jumlah + `</td>
                                                                    </tr>
                                                                `;
                        });
                    ...
                    `
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <td colspan="6" style="padding-bottom: 5px;">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     SALAMATARA, KARELOE BONTORAMBA JENEPONTO                                <br>
