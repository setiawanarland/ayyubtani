                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="data-tables">
                            <table id="PenjualanTable" class="text-cente">
...
@section('scripts')
    <script>
        ...
        var dataRow = function() {
            var init = function() {
                let table = $('#PenjualanTable');
                table.DataTable({
                    processing: true,
                    ordering: false,
                    paging: false,
                    ajax: {
                        url: "/laporan/penjualan-laporan",
                        type: "GET",
                        data: {
                            "bulan": bulan
                        }
        ...
        $('.lihat').on('click', function() {
            ...
            url = `/laporan/penjualan-rekap/?bulan=${bulan}&jenis=pdf`;
            window.open(url);
            // if (bulan !== 'all') {
            // } else {
            //     Swal.fire(
        ...
        $('.cetak').on('click', function() {
            ...
            url = `/laporan/penjualan-rekap/?bulan=${bulan}&jenis=excel`;
            window.open(url);
